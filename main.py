...
customer1 = Customer("Jake", "02/02/1902", 1231231234, "123 Anywhere USA")
customer2 = Customer("Mike", "06/12/1933", 1231231316, "125 Anywhere USA")
customer3 = Customer("Sally", "10/14/2007", 1231231282, "130 Anywhere USA")
def main():
